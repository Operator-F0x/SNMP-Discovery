...
def snmp_discovery(target, user, auth_key, priv_key, auth_protocol, priv_protocol, base_oid):
    ...
    for errorIndication, errorStatus, errorIndex, varBinds in nextCmd(
        SnmpEngine(),
        UsmUserData(user, auth_key, priv_key, authProtocol=auth_protocol, privProtocol=priv_protocol),
...
print(active_ips)
graph = build_topology(active_ips, user, auth_key, priv_key, auth_protocol, priv_protocol)
draw_topology(graph)
